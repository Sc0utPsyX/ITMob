...
ALTER TABLE itmob.user_rights ADD CONSTRAINT fk_user_rights_user_id FOREIGN KEY ( user_id ) REFERENCES itmob.users( id ) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE itmob.user_rights ADD CONSTRAINT fk_user_right_id FOREIGN KEY ( right_id ) REFERENCES itmob.dic_rights( id ) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE itmob.user_details ADD CONSTRAINT fk_user_details_user_id FOREIGN KEY ( user_id ) REFERENCES itmob.users( id ) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
select * from itmob.users;
select * from itmob.user_details;
select * from itmob.dic_rights;
select * from itmob.user_rights;
